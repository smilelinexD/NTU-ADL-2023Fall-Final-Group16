...
## Project Structure
* leditsplusplus/ is copied from [huggingface space](https://huggingface.co/spaces/editing-images/leditsplusplus), modified for generating our anomalous images
```
+ inference.py
+ create_json/*.py
+ metrics/CLIP_I.py
...
```
* visii/ is copied from [GitHub](https://github.com/thaoshibe/visii)
* prompts/ are codes that generate llava/t5 response
...
* Run VISII
```bash= 
python visii/train.py --image_folder ./images --subfolder painting1
```
* generate T5/visii results
```bash=
python prompts/*.py
```
...
| ![./visii/assets/images/teaser.png](./visii/assets/images/teaser.png) |
|:--:|
...
<div style="align: center; text-align:center;">
	<center>
  <img src="./visii/assets/images/your-drawing-of-your-cat.png" alt="result" height="350"/>
  <center>
</div>
...
<table>
  <tr>
  	<td colspan=1><b>Before:</b><br><img src="./visii/images/0_0.png" alt="before" width='200'/></td>
  	<!-- <td>⇨<font style="color:red"> &#60;instruction&#62;🔥 </font>⇨</instruction> -->
  	<td><b>After:</b><br><img src="./visii/images/painting1/0_1.png" alt="after" width='200'/></td>
  	<td colspan=1><b>Test:</b><br><img src="./visii/images/1_0.png" alt="test" width='200'/></td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    ...
    <td colspan=1><img src="./visii/assets/images/ins.png"></td>
  </tr>
  <tr>
  	<td>&#60;ins&#62; + <b>"a husky" 🐶</b></td>
    <td><img src="./visii/assets/images/husky.png"></td>
  </tr>
    <tr>
  	<td>&#60;ins&#62; + <b>"sa quirrel" 🐿️</b></td>
    <td><img src="./visii/assets/images/squirrel.png"></td>
  </tr>
   <tr>
  	<td>&#60;ins&#62; + <b>"a tiger" 🐯</b></td>
    <td><img src="./visii/assets/images/tiger.png"></td>
  </tr>
   <tr>
  	<td>&#60;ins&#62; + <b>"a rabbit" 🐰</b></td>
    <td><img src="./visii/assets/images/rabbit.png"></td>
  </tr>
   <tr>
  	<td>&#60;ins&#62; + <b>"a blue jay" 🐦</b></td>
    <td><img src="./visii/assets/images/bluejay.png"></td>
  </tr>
   <tr>
  	<td>&#60;ins&#62; + <b>"a polar bear" 🐻‍❄️</b></td>
    <td><img src="./visii/assets/images/polar.png"></td>
  </tr>
   <tr>
  	<td>&#60;ins&#62; + <b>"a badger" 🦡</b></td>
    <td><img src="./visii/assets/images/badger.png"></td>
  </tr>
   <tr>
...
<table>
  <tr>
    <td><img src="./visii/assets/images/guidance_scale.png"></td>
  </tr>
...
<table>
  <tr>
    ...
    <!-- <td>⇨<font style="color:red"> &#60;instruction&#62;🔥 </font>⇨</instruction> -->
    <td><b>After:</b><br><img src="./visii/assets/images/prior-vs-ours/starbuck_0_1.png" alt="after" width='200'/></td>
    <td colspan=2></td>
  </tr>
  <tr>
    <td><br><b>Test:</b><br><img src="./visii/assets/images/prior-vs-ours/starbucks_1_0.png" alt="test" width='200'/></td>
    <td><b><font style="color:blue"> &#60;ins&#62; <br></font></b>+ "Wonder Woman"<br><img src="./visii/assets/images/prior-vs-ours/starbucks_wonder_woman.png" alt="ours" width='200'/></td>
    <td><b><font style="color:blue"> &#60;ins&#62; <br></font></b>+ "Scarlet Witch"<br><img src="./visii/assets/images/prior-vs-ours/starbucks_scarlet_witch.png" alt="ours" width='200'/></td>
    <td><b><font style="color:blue"> &#60;ins&#62; <br></font></b>+ "Daenerys Targaryen"<br><img src="./visii/assets/images/prior-vs-ours/starbucks_dragon.png" alt="ours" width='200'/></td>
  </tr>

  <tr>
    <td></td>
    <td><b><font style="color:blue"> &#60;ins&#62; <br></font></b>+ "Neytiri in Avatar"</font><br><img src="./visii/assets/images/prior-vs-ours/starbucks_avatar.png" alt="ours" width='200'/></td>
    <td><b><font style="color:blue"> &#60;ins&#62; <br></font></b>+ "She-Hulk"<br><img src="./visii/assets/images/prior-vs-ours/starbucks_shehulk.png" alt="ours" width='200'/></td>
    <td><b><font style="color:blue"> &#60;ins&#62; <br></font></b>+ "Maleficent"<br><img src="./visii/assets/images/prior-vs-ours/starbucks_maleficent.png" alt="ours" width='200'/></td>
  </tr>
</table>
...
<table>
  <tr>
    <td><img src='./visii/assets/images/optim_progress.png'/></td>
  </tr>
  <tr>
