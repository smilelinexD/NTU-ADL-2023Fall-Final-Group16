...
def edit(input_image,
    ...
    print('text_cross_attention_maps: ', text_cross_attention_maps)
    print('tar_prompt: ', tar_prompt)
    print('image_caption: ', image_caption)
    print('steps: ', steps)
    print('skip: ', skip)
    print('tar_cfg_scale: ', tar_cfg_scale)
    print('edit_concept_1: ', edit_concept_1)
    print('edit_concept_2: ', edit_concept_2)
    print('edit_concept_3: ', edit_concept_3)
    print('guidnace_scale_1: ', guidnace_scale_1)
    print('guidnace_scale_2: ', guidnace_scale_2)
    print('guidnace_scale_3: ', guidnace_scale_3)
    print('warmup_1: ', warmup_1)
    print('warmup_2: ', warmup_2)
    print('warmup_3: ', warmup_3)
    print('neg_guidance_1: ', neg_guidance_1)
    print('neg_guidance_2: ', neg_guidance_2)
    print('neg_guidance_3: ', neg_guidance_3)
    print('threshold_1: ', threshold_1)
    print('threshold_2: ', threshold_2)
    print('threshold_3: ', threshold_3)
    print('do_reconstruction: ', do_reconstruction)
    print('reconstruction: ', reconstruction)
    print('do_inversion: ', do_inversion)
    print('seed: ', seed)
    print('randomize_seed: ', randomize_seed)
    print('src_prompt: ', src_prompt)
    print('src_cfg_scale: ', src_cfg_scale)
